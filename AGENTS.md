...
This project is indexed by GitNexus as **layerflow** (1772 symbols, 2887 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
